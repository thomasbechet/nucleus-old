...
namespace nu::softrast
{
    ...
    nu_result_t mesh_create(const nu_renderer_mesh_create_info_t *info, nu_renderer_mesh_handle_t *handle);
    nu_result_t mesh_destroy(nu_renderer_mesh_handle_t handle);

    nu_result_t texture_create(const nu_renderer_texture_create_info_t *info, nu_renderer_texture_handle_t *handle);
    nu_result_t texture_destroy(nu_renderer_texture_handle_t handle);

    nu_result_t material_create(const nu_renderer_material_create_info_t *info, nu_renderer_material_handle_t *handle);
    nu_result_t material_destroy(nu_renderer_material_handle_t handle);

    nu_result_t font_create(const nu_renderer_font_create_info_t *info, nu_renderer_font_handle_t *handle);
    ...
    nu_result_t camera_create(const nu_renderer_camera_create_info_t *info, nu_renderer_camera_handle_t *handle);
    ...
    nu_result_t model_create(const nu_renderer_model_create_info_t *info, nu_renderer_model_handle_t *handle);
    ...
    nu_result_t label_create(const nu_renderer_label_create_info_t *info, nu_renderer_label_handle_t *handle);
    ...
    nu_result_t rectangle_create(const nu_renderer_rectangle_create_info_t *info, nu_renderer_rectangle_handle_t *handle);
