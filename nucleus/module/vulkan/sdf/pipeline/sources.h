...
typedef enum {
    ...
    NUVK_SDF_PIPELINE_SOURCE_LIGHT_COMP             = 3,
    NUVK_SDF_PIPELINE_SOURCE_POSTPROCESS_FRAG       = 4,
    NUVK_SDF_PIPELINE_SOURCE_POSTPROCESS_VERT       = 5,
    NUVK_SDF_PIPELINE_SOURCE_COUNT                  = 6
