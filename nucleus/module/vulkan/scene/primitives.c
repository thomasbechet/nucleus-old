...
nu_result_t nuvk_primitives_register(nuvk_sdf_t *sdfs)
{
    nu_result_t result = NU_SUCCESS;
    nuvk_sdf_info_t info;

    memset(&info, 0, sizeof(nuvk_sdf_info_t));
    ...
    result &= nuvk_renderer_sdf_create(&info, &sdfs[NUVK_SDF_PRIMITIVE_SPHERE]);
    ...
    result &= nuvk_renderer_sdf_create(&info, &sdfs[NUVK_SDF_PRIMITIVE_CUBE]);
    ...
    result &= nuvk_renderer_sdf_create(&info, &sdfs[NUVK_SDF_PRIMITIVE_MENGER_SPONGE]);
    ...
    result &= nuvk_renderer_sdf_create(&info, &sdfs[NUVK_SDF_PRIMITIVE_TORUS]);
    ...
    result &= nuvk_renderer_sdf_create(&info, &sdfs[NUVK_SDF_PRIMITIVE_PLANE]);
