...
nu_result_t nusr::camera_set_eye(nu_renderer_camera_handle_t handle, const nu_vec3_t eye)
{
    _data.engine->setCameraEye(eye);
    return NU_SUCCESS;
}
nu_result_t nusr::camera_set_center(nu_renderer_camera_handle_t handle, const nu_vec3_t center)
{
    _data.engine->setCameraCenter(center);
    return NU_SUCCESS;
}
...
nu_result_t nusr::model_set_transform(nu_renderer_model_handle_t handle, const nu_mat4_t transform)
{
