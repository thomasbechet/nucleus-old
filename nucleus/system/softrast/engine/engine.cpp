...
void Engine::setModelTransform(nu_renderer_model_handle_t handle, const nu_mat4_t transform)
{
...
void Engine::setCameraEye(const nu_vec3_t eye)
{
    m_scene.setCameraEye(eye);
}
void Engine::setCameraCenter(const nu_vec3_t center)
{
    m_scene.setCameraCenter(center);
}