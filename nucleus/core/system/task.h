...
NU_API nu_result_t nu_task_perform(nu_task_handle_t task, nu_job_t *jobs, uint32_t count);
NU_API nu_result_t nu_task_perform_parallel(nu_task_handle_t task, nu_job_t job, uint32_t count);
