...
typedef bool (*nu_indexed_array_eq_pfn_t)(const void *a, const void *b);
...
NU_API void nu_indexed_array_get(nu_indexed_array_t array, uint32_t id, void *pdata);
NU_API bool nu_indexed_array_find_id(nu_indexed_array_t array, nu_indexed_array_eq_pfn_t find_pfn, const void *user, uint32_t *id);
