...
NU_API nu_result_t nu_module_load(const char *path, nu_module_handle_t *handle);
...
NU_API nu_result_t nu_module_get_by_name(const char *name, nu_module_handle_t *handle);
NU_API nu_result_t nu_module_get_by_id(uint32_t id, nu_module_handle_t *handle);
