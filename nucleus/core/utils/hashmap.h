...
typedef uint32_t (*nu_hashmap_hash_t)(void*, void*);

NU_API void nu_hashmap_allocate(uint32_t key_size, uint32_t value_size, nu_hashmap_hash_t hash, nu_hashmap_t *hashmap);
